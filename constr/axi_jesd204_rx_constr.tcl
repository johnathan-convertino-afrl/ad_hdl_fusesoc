...
#
# TCL script to create axi_jesd204_rx constraints for every instantiated core.
# created by Jay Convertino

foreach instance [get_cells -hier -filter {ref_name==axi_jesd204_rx || orig_ref_name==axi_jesd204_rx}] {
  ...
  set_false_path \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_status/out_toggle_d1_reg/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_status/i_sync_in/cdc_sync_stage1_reg[0]/D]

  set_false_path \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_cfg/in_toggle_d1_reg/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_cfg/i_sync_out/cdc_sync_stage1_reg[0]/D]

  set_false_path \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_cfg/out_toggle_d1_reg/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_cfg/i_sync_in/cdc_sync_stage1_reg[0]/D]
  ...
  set_false_path \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_sync_frame_align_err/in_toggle_d1_reg/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_sync_frame_align_err/i_sync_out/cdc_sync_stage1_reg[0]/D]

  set_false_path \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_sync_frame_align_err/out_toggle_d1_reg/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_sync_frame_align_err/i_sync_in/cdc_sync_stage1_reg[0]/D]

  set_false_path \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_sync_frame_align_err/cdc_hold_reg*/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_sync_frame_align_err/out_event_reg*/D]

  # Don't place them too far appart
  set_max_delay -datapath_only \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_status/cdc_hold_reg[*]/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_status/out_data_reg[*]/D] \
    [get_property -min PERIOD $axi_clk]

  set_false_path \
    -from $core_clk \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/*i_up_rx_lane/i_cdc_status_ready/cdc_sync_stage1_reg*/D]

  set_max_delay -datapath_only \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_cfg/cdc_hold_reg[*]/C] \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/i_cdc_cfg/out_data_reg[*]/D] \
    [get_property -min PERIOD $core_clk]

  set_max_delay -datapath_only \
    -from $core_clk \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/*i_up_rx_lane/up_status_latency_reg[*]/D] \
    [get_property -min PERIOD $axi_clk]

  set_false_path \
    -from $core_clk \
    -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/*i_up_rx_lane/i_ilas_mem/i_cdc_ilas_ready/cdc_sync_stage1_reg[0]/D]

  # Use -quiet here since the ILAS mem is missing in non 8b10b configuration
  set_max_delay -quiet -datapath_only \
  -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/gen_lane[*].i_up_rx_lane/i_ilas_mem/mem_reg*/*/CLK] \
  -to [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/gen_lane[*].i_up_rx_lane/i_ilas_mem/dp_*_gen.up_rdata_reg*/D] \
    [get_property -min PERIOD $axi_clk]
  ...
  set_max_delay -datapath_only \
    -from [get_pins -of [get_cells -hier -filter parent=~$instance*] -filter name=~i_up_rx/up_cfg_*_reg*/C] \
